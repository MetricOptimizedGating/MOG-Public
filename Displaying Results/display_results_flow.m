function varargout = display_results_flow(varargin)
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @display_results_flow_OpeningFcn, ...
    'gui_OutputFcn',  @display_results_flow_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before display_results_flow is made visible.
function display_results_flow_OpeningFcn(hObject, dummy, handles, varargin)
movegui('center')
